...
function demoCfg() {
    return {
        ...
        pantalla: 'ESTA ES LA PANTALLA DEL SET · CÁMBIAME EN LA PESTAÑA EDITAR',
        ...
        extras: [{ ...GFX }, { ...CORTE }],
        escaleta: [
            { id: 'demo-seg-1', segmento: '1. Lee la escaleta de arriba a abajo', dur: 30, fuente: 'demo-cam-1', nota: 'Cada fila es un segmento del programa. Se edita en la pestaña Editar de Infografías.' },
            ...
            { id: 'demo-seg-3', segmento: '3. La duración alimenta la Línea de tiempo', dur: 60, fuente: 'demo-cam-3', nota: 'Cambia mi duración y abre la pestaña Escaleta / Rundown (⌘3) para ver el efecto.' },
            ...
            { id: 'demo-seg-5', segmento: '5. Prueba el Modo Producción ▶ (⌘5)', dur: 45, fuente: 'demo-cam-1', nota: 'El cronómetro en vivo sigue esta escaleta segmento por segmento.' },
        ],
