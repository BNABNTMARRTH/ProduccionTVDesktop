/**
 * export_visitor.js — GoF Visitor Pattern para Exportación de Proyectos TV
 * 
 * Permite definir operaciones independientes sobre los elementos de un proyecto
 * (Escaleta, Cámaras, Audio, Iluminación, Presupuesto, Diagrama) sin modificar sus estructuras.
 * 
 * Implementa:
 * - EdlExportVisitor: Genera lista de decisiones de edición CMX 3600 (DaVinci Resolve, Premiere, FCP).
 * - CsvExportVisitor: Genera tablas de escaleta y desglose en formato CSV estándar.
 * - MarkdownExportVisitor: Genera dossier de producción técnica en Markdown.
 * - SummaryExportVisitor: Genera un resumen analítico del proyecto.
 */

// ============================================================================
// Elementos Visitables (Visitable Elements)
// ============================================================================

export class ProjectInfoElement {
  constructor(info = {}) {
  ...
  accept(visitor) {
    return visitor.visitProjectInfo(this);
  }
}
...
export class BudgetElement {
  ...
  accept(visitor) {
    return visitor.visitBudget(this);
  }
}

export class RundownElement {
  constructor(escaleta = []) {
    this.items = Array.isArray(escaleta) ? escaleta : [];
  }

  accept(visitor) {
    return visitor.visitRundown(this);
  }
}

export class CamerasElement {
  constructor(camaras = []) {
    this.items = Array.isArray(camaras) ? camaras : [];
  }

  accept(visitor) {
    return visitor.visitCameras(this);
  }
}
 ...
 */
export class ProductionProject {
  constructor(data = {}) {
...
// ============================================================================
// Visitante Concreto 1: CMX 3600 EDL (Edit Decision List)
// ============================================================================

export class EdlExportVisitor extends ProjectVisitor {
  constructor(fps = 30) {
    super();
  ...
  visitRundown(element) {
    ...
    element.items.forEach((item) => {
      ...
      // Línea estándar CMX 3600: NUM REEL TRACK TRANS [FLAGS] SRC_IN SRC_OUT REC_IN REC_OUT
...
// ============================================================================
// Visitante Concreto 2: CSV Export (Escaleta y Recursos de Producción)
// ============================================================================

export class CsvExportVisitor extends ProjectVisitor {
  constructor() {
    super();
    this.sections = [];
...
// ============================================================================
// Visitante Concreto 3: Markdown Technical Dossier
// ============================================================================

export class MarkdownExportVisitor extends ProjectVisitor {
  constructor() {
    super();
    this.md = [];
  }
...
// ============================================================================
// GoF Composite Pattern: Dossier Estructurado
// ============================================================================

export class DossierNode {
  getPages() { return []; }
  getPageCount() { return this.getPages().length; }
}

export class PageLeaf extends DossierNode {
  ...
  getPages() {
    return [{ name: this.name, html: this.html, fillable: this.fillable }];
  }
}

export class SectionComposite extends DossierNode {
...
export class DossierComposite extends DossierNode {
  constructor() {
    super();
    this.sections = [];
  }
  ...
  getPages() {
    return this.sections.flatMap((s) => s.getPages());
  }
}

// ============================================================================
// GoF Strategy Pattern: Estrategias de Exportación
// ============================================================================
...
export class EdlExportStrategy extends ExportStrategy {
...
// Compatibilidad con entornos de navegador directo
