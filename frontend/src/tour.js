...
// etapa del proyecto y explican, en orden pedagógico (mensaje → historia →
...
const PASOS = [
  ...
  { view: 'perfil', target: '.rail',
    titulo: 'Tu ruta de producción',
    cuerpo: 'La barra de la izquierda son las <b>etapas</b> de toda producción, en orden: <b>Perfil → Guion → Necesidades → Planeación</b>, y al final los documentos. Cada etapa se marca <b>✓</b> cuando ya tiene lo suyo, así siempre sabes qué sigue.' },
  { view: 'necesidades', target: '#secciones',
    titulo: 'Las secciones de cada etapa',
    cuerpo: 'Cuando una etapa tiene varias partes, aparecen aquí arriba. También puedes saltar entre etapas con <b>⌘1–⌘6</b>. El nombre del proyecto, arriba a la izquierda, te regresa a Inicio.' },
  { view: 'escaleta', target: '[data-etapa="guion"]',
    titulo: '1 · El mensaje y la historia',
    cuerpo: 'Toda producción empieza por el <b>porqué</b>. En <b>Guion</b> escribes qué pasa y en qué orden: agrega los bloques o escenas que necesites, con la duración de cada uno. Puedes agregar, borrar y reordenar en cualquier momento.' },
  { view: 'escaleta', target: '[data-etapa="guion"]',
  ...
  { view: 'set', target: '[data-etapa="planeacion"]',
    titulo: '4 · Set e iluminación',
    cuerpo: 'En <b>Planeación</b> montas el espacio físico: mobiliario, cámaras y, sobre todo, la <b>iluminación</b> (esquema de tres puntos y más). Arrastra los elementos en la planta para colocarlos donde van.' },
  { view: 'diagrama', target: '[data-etapa="necesidades"]',
    titulo: '5 · La señal',
    cuerpo: 'En <b>Necesidades → Ruta de señal</b> conectas cámaras, micrófonos y switcher: la ruta de video y audio. <b>⚡ Autoconectar</b> arma la cadena estándar y te avisa qué falta antes de salir al aire.' },
  { view: 'production', target: '[data-etapa="ensayo"]',
    titulo: '6 · ¡Al aire!',
    cuerpo: 'En <b>Ensayo</b> corres tu escaleta en vivo: cronómetro, <b>tally</b> de cámaras y teleprompter. Es tu cabina el día del rodaje.' },
  { view: 'exportar', target: '[data-etapa="salida"]',
    titulo: 'Comparte tu trabajo',
    cuerpo: 'En <b>Documentos</b> armas el paquete final: PDF para imprimir, PNG o el proyecto <b>.ptv</b> para compartir con tu equipo o entregarlo.' },
  { view: 'perfil', target: null,
    titulo: '🎬 ¡A grabar!',
