...
const PASOS = [
  ...
  { view: 'infografias', target: '.header-tabs',
    titulo: 'Cómo navegar',
    cuerpo: 'Desde aquí cambias entre las herramientas (o con <b>⌘1–⌘7</b>). El nombre del proyecto, arriba a la derecha, te regresa a Inicio.' },
